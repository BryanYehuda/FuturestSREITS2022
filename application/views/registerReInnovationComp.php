 ...
 <body>
                                             ...
                                             <form action="#" class="" id="form" method="post">
                                                 ...
                                                 <div class="form-group text-dark ">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" id="name_3" name="name_3" placeholder="Your Name ll Ex: Devitweb development" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" id="major_3" name="major_3" placeholder="Major ll Ex: Information Technology" required>
                                                 ...
                                                 <select class="form-select <?php $ok = " ";
                                                                            ...
                                                                            echo $ok; ?>" aria-label="Default select example" id="batch_3" name="batch_3" required>
                                                     <option selected>-</option>
                                                     <option value="1">2019</option>
                                                     <option value="2">2020</option>
                                                     <option value="3">2021</option>
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <input class="form-control text-dark <?php $ok = " ";
                                                                                            ...
                                                                                            echo $ok; ?>" type="file" id="card_3" name="card_3" multiple required>
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <input class="form-control text-dark <?php $ok = " ";
                                                                                            ...
                                                                                            echo $ok; ?>" type="file" id="activestudent_3" name="activestudent_3" multiple required>
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <input class="form-control text-dark <?php $ok = " ";
                                                                                            ...
                                                                                            echo $ok; ?>" type="file" id="photo_3" name="photo_3" multiple required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="phone" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" id="phone_3" name="phone_3" placeholder="phone ll Ex: 08XX XXXX XXXX" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="email" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" id="email_3" name="email_3" placeholder="Email ll Ex: Devitweb@gmail.com" required>
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <input class="form-control text-dark <?php $ok = " ";
                                                                                            ...
                                                                                            echo $ok; ?>" type="file" id="follow_3" name="follow_3" multiple required>
     ...
     <!-- Import js if need -->
     <script>
         var url = '<?php echo base_url() . 'Auth_regis/regisReInnovation' ?>';
     </script>
     <script>
