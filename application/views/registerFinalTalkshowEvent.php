 ...
 <body>
             ...
             <div class="container register center">
                 ...
                 <div class="row">
                     <div class=".col-6 .col-md-10 register-right ">
                         <br>
                         <h1 class="register text-center">Final Talkshow</h1>
                                             ...
                                             <form action="#" class="" method="post" id="form">
                                                 <div class="form-group text-dark ">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="name" id="name" placeholder="Your Name ll Ex: Devitweb development" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="email" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="email" id="email" placeholder="Email ll Ex: Devitweb@gmail.com" required>
                                                 ...
                                                 <div class=" form-group text-dark">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="domicile" id="domicile" placeholder="Domicile ll Ex: Surabaya, Jawa Timur" required>
                                                 ...
                                                 <div>
                                                     ...
                                                     <textarea class="form-control text-dark  <?php $ok = " ";
                                                                                                (form_error('question') > 0) ? $ok = 'is-invalid' :  $ok = '';
                                                                                                echo $ok; ?>" id="question" name="question" placeholder="Any Questions?" rows="3" required></textarea>
     ...
     <!-- Import js if need -->
     <script>
         var url = '<?php echo base_url() . 'Auth_regis/regisFinalTalkshow' ?>';
     </script>
     <script>
