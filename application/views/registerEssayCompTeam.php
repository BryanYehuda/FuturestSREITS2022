 ...
 <body>
             ...
             <div class="container register center">
                 ...
                 <div class="row">
                     <div class=".col-6 .col-md-10 register-right ">
                         <br>
                         <h1 class="register text-center">Essay Competition <b>Team</b></h1>
                                             ...
                                             <form action="#" class="" id="form" method="post">
                                                 ...
                                                 <div class="form-group text-dark ">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="teamname" id="teamname" placeholder="Team Name ll Ex: FuturesTeam" required>
                                                 ...
                                                 <div class="form-group text-dark ">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="name_1" id="name_1" placeholder="Your Name ll Ex: Devitweb development" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="number" class="form-control text-dark <?php $ok = " ";
                                                                                                        (form_error('age_1') > 0) ? $ok = 'is-invalid' :  $ok = '';
                                                                                                        echo $ok; ?>" name="age_1" id="age_1" placeholder="age ll Ex: 24" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        (form_error('university_1') > 0) ? $ok = 'is-invalid' :  $ok = '';
                                                                                                        echo $ok; ?>" id="university_1" name="university_1" placeholder="University ll Ex: Institut Teknologi Sepuluh Nopember" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" id="major_1" name="major_1" placeholder="Major ll Ex: Information Technology">
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="phone" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="phone_1" id="phone_1" placeholder="phone ll Ex: 08XX XXXX XXXX" required>
                                                 ...
                                                 <div class="form-group text-dark ">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="name_2" id="name_2" placeholder="Your Name ll Ex: Devitweb development" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     <label for="age"><i class="text-dark float"></i> Age <b>(17-24)</b> </label>
                                                     <input type="number" class="form-control text-dark <?php $ok = " ";
                                                                                                        (form_error('age_2') > 0) ? $ok = 'is-invalid' :  $ok = '';
                                                                                                        echo $ok; ?>" name="age_2" id="age_2" placeholder="age ll Ex: 24" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     <label for="name"><i class="float"></i> Institution </label>
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        (form_error('university_2') > 0) ? $ok = 'is-invalid' :  $ok = '';
                                                                                                        echo $ok; ?>" id="university_2" name="university_2" placeholder="University ll Ex: Institut Teknologi Sepuluh Nopember" required>
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="text" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" id="major_2" name="major_2" placeholder="Major ll Ex: Information Technology">
                                                 ...
                                                 <div class="form-group text-dark">
                                                     ...
                                                     <input type="phone" class="form-control text-dark <?php $ok = " ";
                                                                                                        ...
                                                                                                        echo $ok; ?>" name="phone_2" id="phone_2" placeholder="phone ll Ex: 08XX XXXX XXXX" required>
                                                 ...
                                                 <div class="mb-3">
                                                     ...
                                                     <input class="form-control text-dark <?php $ok = " ";
                                                                                            (!empty($error['payment'])) ? $ok = 'is-invalid' :  $ok = '';
                                                                                            echo $ok; ?>" type="file" id="payment" name="payment" multiple required>
     ...
     <!-- Import js if need -->
     <script>
         var url = '<?php echo base_url() . 'Auth_regis/regisEssayCompTeam' ?>';
     </script>
     <script>
