    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <a href="<?php echo base_url('dashboard-national-essay')?>" class="list-group-item list-group-item-action bg-transparent primary-text second-text"><i class="fas fa-home-alt me-2"></i>Home</a>
                ...
                <a href="<?php echo base_url('dashboard-national-essay-payment') ?>" class="list-group-item list-group-item-action bg-transparent second-text primary-text active"><i class="fas fa-money-check-alt me-2"></i>Payment</a>
                <hr class="info-color">
                                ...
                                <tr class="invoice-row shadow regular-text" valign="middle">
                                    <td>
                                        <?php if($item['pendaftaranessaycompetition_teamname'] != '--INDIVIDU--'){?>
                                            <?= $item['pendaftaranessaycompetition_teamname']?>
                                        <?php }elseif($item['pendaftaranessaycompetition_teamname'] == '--INDIVIDU--'){?>
                                            <?= $item['pendaftaranessaycompetition_1_name']?>
                                        <?php }?>
                                    </td>

                                    <td>
                                        <?=$item['pendaftaranessaycompetition_1_phone']?>
                                    </td>
                                    <td>
                                        <?php if($item['pendaftaranessaycompetition_status'] != 2) {?>
                                            <a href= "national_essay/confirmpay/<?= $item['pendaftaranessaycompetition_id']?>" class="btn btn-success" id="accept-<?= $item['pendaftaranessaycompetition_id']?>" onclick="accept(this.id)">
                                                <i class="hide loading-icon fa fa-spinner fa-spin d-none" id="loading-accept-<?= $item['pendaftaranessaycompetition_id']?>"></i>Accept
                                            </a>
                                        <?php }elseif($item['pendaftaranessaycompetition_status'] == 2){?>
                                            <a href="national_essay/cancelpay/<?= $item['pendaftaranessaycompetition_id']?>" class="btn btn-danger" id="reject-<?= $item['pendaftaranessaycompetition_id']?>" onclick="reject(this.id)">
                                                <i class="hide loading-icon fa fa-spinner fa-spin d-none" id="loading-reject-<?= $item['pendaftaranessaycompetition_id']?>"></i>Cancel
                                            </a>
                                        <?php }?>
                                    </td>
