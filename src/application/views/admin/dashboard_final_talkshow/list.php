...
<head>
    ...
    <title>Final Talkshow - List</title>
</head>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="primary-text">Welcome to Dashboard Futurest Final Talkshow</h2>
                </div>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle second-text fw-bold" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-user me-2 info-color"></i>@FuturestFinalTalkshow
                            </a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><?= $i++;?></th>
                                        <td><?= $item['pendaftaranfinaltalkshow_name']?></td>
                                        <td><?= $item['pendaftaranfinaltalkshow_email']?></td>
                                        <td><?= $item['pendaftaranfinaltalkshow_domicile']?></td>
                                        <td><?= $item['pendaftaranfinaltalkshow_university']?></td>
                                        <td><?= $item['pendaftaranfinaltalkshow_major']?></td>
                                        <td><?= $item['pendaftaranfinaltalkshow_batch']?></td>
                                        <td><?= $item['pendaftaranfinaltalkshow_question']?></td>
                                        <td><a href="<?php echo base_url('/upload/FinalTalkshow/followfuturestig/' . $item['pendaftaranfinaltalkshow_followingfuturestig'])?>" target="_blank">Show</a></td>
                                        <td><a href="<?php echo base_url('/upload/FinalTalkshow/followsreig/' . $item['pendaftaranfinaltalkshow_followingsreig'])?>" target="_blank">Show</a></td>
                                        <td><a href="<?php echo base_url('/upload/FinalTalkshow/sharestory/' . $item['pendaftaranfinaltalkshow_sharestory'])?>" target="_blank">Show</a></td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
                            </table>
