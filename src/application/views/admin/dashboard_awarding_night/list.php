...
<head>
    ...
    <title>Awarding Night - List</title>
</head>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="<?php echo base_url('dashboard-awarding-night')?>" class="list-group-item list-group-item-action bg-transparent primary-text"><i class="fas fa-home-alt me-2"></i>Home</a>
                <a href="<?php echo base_url('dashboard-awarding-night-list')?>" class="list-group-item list-group-item-action bg-transparent second-text primary-text active"><i class="fas fa-users-cog me-2"></i>Winner List</a>                <hr class="info-color">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4 pb-5">
                <div class="row g-3 my-2">
                    <h4 class="mb-3 primary-text">List of Winner</h4>
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row"><?= $i++;?></th>
                                        <td><?= $item['pendaftaranawardingnight_name']?></td>
                                        <td><?= $item['pendaftaranawardingnight_university']?></td>
                                        <td><?= $item['pendaftaranawardingnight_email']?></td>
                                        <td><?= $item['pendaftaranawardingnight_juara']?></td>
                                        <td><?= $item['pendaftaranawardingnight_bidang']?></td>
                                    </tr>
                                    <?php endforeach;?>
                                </tbody>
                            </table>
