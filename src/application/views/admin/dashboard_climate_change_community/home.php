    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="<?php echo base_url('dashboard-climate-change-community')?>" class="list-group-item list-group-item-action bg-transparent primary-text active"><i class="fas fa-home-alt me-2"></i>Home</a>
                <a href="<?php echo base_url('dashboard-climate-change-community-list')?>" class="list-group-item list-group-item-action bg-transparent second-text primary-text"><i class="fas fa-users-cog me-2"></i>Registeree List</a>                <hr class="info-color">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="<?php echo base_url('dashboard-climate-change-community')?>">Home</a></li>
                                <li><a class="dropdown-item" href="<?php echo base_url('dashboard-climate-change-community-list')?>">Registeree List</a></li>
                ...
                <div class="row g-3 my-2">
                    ...
                    <div class="col-lg-3 col-md-6 ">
                        <div class="p-3 bg-white shadow d-flex justify-content-around align-items-center info-card">
                            ...
                            <div>
                                <p class="fs-6 text-black-50 regular-text">Number of Registeree</p>
