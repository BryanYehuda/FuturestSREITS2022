...
<head>
    ...
    <title>RE Innovation - Power Point List</title>
</head>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4 pb-5">
                <div class="row g-3 my-2">
                    <h4 class="mb-3 primary-text">Power Point List</h4>

                    <?php foreach($data as $item):?>
                        <?php if( $item['pendaftaranreinnovation_ppt'] != NULL){?>
                        <div class="col-12 col-sm-6 mb-3">
                            ...
                            <hr>                                
                                ...
                                <p class="fs-6 text-black-50 regular-text" style="margin-bottom: -4px;">Power Point</p>
                                <a href="<?= base_url('/upload/REinnovation/ppt/' . $item['pendaftaranreinnovation_ppt'])?>" target="_blank">Show</a></h5>
