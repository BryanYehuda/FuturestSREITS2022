                ...
                <div class="row g-3 my-2">
                    ...
                    <div class="col-12 col-sm-6 mb-3">
                        ...
                        <hr>                                
                            ...
                            <a href="re_innovation/reject/<?= $item['pendaftaranreinnovation_id']?>" class="btn btn-danger" id="reject-<?= $item['pendaftaranreinnovation_id']?>" onclick="reject(this.id)">
                                <i class="hide loading-icon fa fa-spinner fa-spin d-none" id="loading-reject-<?= $item['pendaftaranreinnovation_id']?>"></i>Reject
                            </a>
                        </div>
                    </div>
                    <?php endforeach;?>
