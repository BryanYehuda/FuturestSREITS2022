...
<body>
            ...
            <div class="container register center">
                ...
                <div class="row">
                    <div class=".col-6 .col-md-10 register-right ">
                        ...
                        <h1 class="register text-center">Register Final Talkshow</h1>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>public/js/backend/registerfinaltalkshow.js"></script>
</body>
