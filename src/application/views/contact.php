...
<body>
  ...
  <main id="section">
    ...
    <!-- Futurest Sosmed -->
    <section id="re-contact" class="pt-5">
      <div class="container pt-5">
        ...
        <div class="row mt-5 px-3 d-flex justify-content-center">
          ...
          <div class="card-re-contact m-3 col-md-4 p-0" style="background-color: #e3e3e3;">
            <img src="<?php echo base_url() ?>public/img/personal-contact.jpg" alt="" class="img-fluid" />
            <div class="p-3">
              <h3>Chindy</h3>
              <p>
                Line: chindy_rosita
    ...
    <section id="contact-us" class="d-flex align-items-center">
      <div class="container h-75">
        <h2 class="text-center mb-5">Or contact us directly</h2>
        <form action="">
          <div class="mb-5">
