...
<!-- Navbar CSS -->
<link rel="stylesheet" href="<?php echo base_url() ?>/public/css/components/navbar.css">

<!-- Footer CSS -->
<link rel="stylesheet" href="<?php echo base_url() ?>/public/css/components/footer.css">
