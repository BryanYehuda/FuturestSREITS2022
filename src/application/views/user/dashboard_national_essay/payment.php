...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?php echo base_url() ?>public/css/pages/dashboard_user_payment.css">
...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            <div class="sidebar-heading text-center py-4 img-fluid"><img
                    src="<?php echo base_url() ?>/public/img/Logo.png" alt="Futurest 2022"></div>
            <div class="list-group list-group-flush my-3">

                <a href="<?php echo base_url('user')?>"
                    class="list-group-item list-group-item-action bg-transparent primary-text second-text"><i
                ...
                <a href="<?php echo base_url('logout')?>"
                    class="list-group-item list-group-item-action bg-transparent text-danger primary-text"><i
                        ...
                        <table class="table table-borderless row-gap center">
                            <tbody>
                                ...
                                <tr class="invoice-row shadow regular-text" valign="middle">
                                    <?php $create = explode(" ", $data[0]['pendaftaranessaycompetition_dataCreated']);?>
                                    <td>
                                        <?= $create[0]?>
                                        <br>
                                        <?= $create[1]?>
                                ...
                                <tr class="invoice-row shadow regular-text" valign="middle">
                                <?php $update = explode(" ", $data[0]['pendaftaranessaycompetition_dataUpdated']);?>
                                    <td>
                                        <?= $update[0]?>
                                        <br>
                                        <?= $update[1]?>
