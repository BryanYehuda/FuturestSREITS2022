                ...
                <div class="row g-3 my-2">
                    ...
                    <div class="col-lg-3 col-md-6 ">
                        <div class="p-3 bg-white shadow d-flex justify-content-around align-items-center info-card">
                            ...
                            <?php //var_dump($data);
                            if($data[0]['pendaftaranessaycompetition_teamname'] === '--INDIVIDU--'){?>
                            <div>
                                <p class="fs-6 text-black-50 regular-text">Name</p>
                                <h5 class="primary-text"><?= $data[0]['pendaftaranessaycompetition_1_name']?></h5>
                            </div>
                            <?php }else{?>
                                <div>
                    ...
                    <div class="col-lg-3 col-md-6 ">
                        <div class="p-3 bg-white shadow d-flex justify-content-around align-items-center info-card">
                            ...
                            <div>
                                ...
                                <h5 class="primary-text"><?= $data[0]['pendaftaranessaycompetition_1_college']?></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 ">
                        <div class="p-3 bg-white shadow d-flex justify-content-around align-items-center info-card">
                            ...
                            <div>
                                ...
                                <?php if($data[0]['pendaftaranessaycompetition_status'] != 2) {?>
                                    <h5 class="text-danger"><b>Not Verified</b></h5>
                                <?php }elseif($data[0]['pendaftaranessaycompetition_status'] == 2){?>
                                    <h5 class="status-color primary-text">Verified</h5>
                                <?php }?>
                            </div>
                    ...
                    <div class="col-md-6 p-2">
                        <!--<div class="card announcement-card shadow">
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('user/Essay')?>" class="btn btn-outline-success">Upload</a>
                            </div>
                        </div>-->
                    </div>
                </div>
