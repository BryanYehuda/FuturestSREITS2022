...
<body>
                                    ...
                                    <div class="col-md-13  container">
                                        <div class="col-md-7  container">
                                            ...
                                            <form action="#" class="" method="post" id="form">
                                                ...
                                                <div class="mb-3">
                                                    <label for="name"><i class="float"></i> Essay</label>
                                                    <input class="form-control text-dark" type="file" id="Essay" multiple name="Essay" required>
                                                    <div class="invalid-feedback" id="Essay-false">
    ...
    <!-- Import js if need -->
    <script>var s_url = './submitesai'</script>
