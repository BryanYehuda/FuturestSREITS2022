...
<body>
                                        ...
                                        <div class="col-md-7  container">
                                            ...
                                            <form action="#" class="" method="post" id="form">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control text-dark" type="file" id="abstract" multiple name="abstract" required>
                                                    <div class="invalid-feedback" id="abstract-false">
    ...
    <!-- Import js if need -->
    <script>var s_url = './submitabstract'</script>
