                ...
                <div class="row g-3 my-2">
                    ...
                    <div class="col-12">
                        <div class="p-3 bg-white shadow info-card">
                            ...
                            <h5 class="primary-text mb-3"><?= $data[0]['pendaftaranreinnovation_teamname']?></h5>

                            <p class="fs-6 text-black-50 regular-text" style="margin-bottom: 1px;">Institution</p>
                            <h5 class="primary-text mb-3"><?= $data[0]['pendaftaranreinnovation_college']?></h5>

                            <p class="fs-6 text-black-50 regular-text" style="margin-bottom: 1px;">Member Team</p>
                            <h5 class="primary-text mb-3 fs-6">
                                <ul>
                                    <li><?= $data[0]['pendaftaranreinnovation_1_name']?></li>
                                    <li><?= $data[0]['pendaftaranreinnovation_2_name']?></li>
                                    <?php if(!empty($data[0]['pendaftaranreinnovation_3_name'])){ ?>
                                        <li><?= $data[0]['pendaftaranreinnovation_3_name']?></li>
                                    <?php } ?>
                                </ul>
                            </h5>
