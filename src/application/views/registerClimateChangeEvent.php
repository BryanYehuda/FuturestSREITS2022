                                        ...
                                        <div class="col-md-7  container">
                                            ...
                                            <form action="#" class="" id="form" method="post">
                                                ...
                                                <div class="form-group text-dark ">
                                                    ...
                                                    <input type="text" class="form-control text-dark <?php $ok = " "; (form_error('name') > 0) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" id="name" name="name" placeholder="Your Name ll Ex: Devitweb development" required>
                                                ...
                                                <div class="form-group text-dark">
                                                    ...
                                                    <input type="email" class="form-control text-dark <?php $ok = " "; (form_error('email') > 0) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" id="email" name="email" placeholder="Email ll Ex: Devitweb@gmail.com" required>
                                                ...
                                                <div class=" form-group text-dark">
                                                    ...
                                                    <input type="text" class="form-control text-dark <?php $ok = " "; (form_error('domicile') > 0) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" id="domicile" name="domicile" placeholder="Domicile ll Ex: Surabaya, Jawa Timur" required>
                                                ...
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control text-dark <?php $ok = " "; (form_error('linkedin') > 0) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" id="linkedin" aria-describedby="basic-addon3" placeholder="Linkedin URL ll Ex: https://www.linkedin.com/company/futureenergysummit/" name="linkedin">
                                                ...
                                                <div class="form-group text-dark ">
                                                    ...
                                                    <textarea class="form-control text-dark <?php $ok = " "; (form_error('motivation') > 0) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" class="form-control text-dark" id="motivation" name="motivation" placeholder="Your Motivation..." rows="3"></textarea>
                                                ...
                                                <div class="form-group text-dark ">
                                                    ...
                                                    <textarea class="form-control text-dark <?php $ok = " "; (form_error('contibution') > 0) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" class="form-control text-dark" id="contribution"name="contribution" placeholder="Your Contribution..." rows="3"></textarea>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control text-dark <?php $ok = " "; (!empty($error['twibbon'])) ? $ok='is-invalid' :  $ok='' ;echo $ok;?>" type="file" id="twibbon" multiple name="twibbon"> 
