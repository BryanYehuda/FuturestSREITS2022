...
<head>
    ...
    <title>Admin Dashboard - Confirmation</title>
</head>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="<?php echo base_url('admin')?>" class="list-group-item list-group-item-action bg-transparent primary-text second-text"><i class="fas fa-home-alt me-2"></i>Home</a>
                ...
                <a href="<?php echo base_url('admin/confirmation')?>" class="list-group-item list-group-item-action bg-transparent second-text primary-text active"><i class="fas fa-money-check-alt me-2"></i>Confirmation</a>
                <hr class="info-color">
                ...
                <div class="row g-3 my-2">
                    ...
                    <div class="col-12 col-sm-6 mb-3">
                        <div class="p-3 bg-white shadow info-card">
                            ...
                            <a href="<?php echo base_url() ?>/public/img/bukti-tf.png" class="d-block mb-2" target="_blank" rel>Show</a>

                            <p class="fs-6 text-black-50 regular-text" style="margin-bottom: 1px;">Confirmation?</p>
