...
$("button#submit").on('click', function(){
    ...
    $.ajax({
        url: './Auth_regis/regisReInnovation',
        type: "POST",
        ...
        success: function(response){
            if(response == "1"){
                Swal.fire({
                    title: 'Thank you for your interest and registration in the RE-Innonvation!',
                    text: 'Kindly check your email for further notice!',
                    type: 'success',
                    icon: 'success',
                    confirmButtonText: 'Go Back'
                }).then( function(){
                    window.location.href = base_url + 'register-re-innovation-comp';
                });
