...
$("button#submit").on('click', function(){
    ...
    $.ajax({
        url: './Auth_regis/regisEssayCompIndividu',
        type: "POST",
        ...
        success: function(response){
            if(response == "1"){
                Swal.fire({
                    title: 'Thank you for your interest and registration in the Essay Competition!',
                    text: 'Kindly check your email for further notice!',
                    type: 'success',
                    icon: 'success',
                    confirmButtonText: 'Go Back'
                }).then( function(){
                    window.location.href = base_url + 'register-essay-comp-individual';
                });
